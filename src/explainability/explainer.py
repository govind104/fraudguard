...
class FraudExplainer:
    ...
    def explain(
        ...
        try:
            ...
            top_features = self._extract_feature_importances(explanation, node_idx, top_k)

            # Extract subgraph
            subgraph_nodes = self._extract_subgraph(explanation, edge_index, node_idx)

            # Extract edge importances
            edge_importances = self._extract_edge_importances(explanation, edge_index)
